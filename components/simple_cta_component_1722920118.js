...
Vue.component("simple_cta_component_1722920118", {
    template: `
    <section id="cta-component" style="min-height: 590px"   class="bg-gradient-to-br from-pink-400 to-purple-600 flex-1 min-h-screen flex items-center justify-center p-4">
        <div id="cta-inner-container" class="max-w-screen-xl mx-auto bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8">
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-white md:text-lg">Discover recipes, plan meals, and simplify cooking with our intuitive apps.</p>
                </div>
